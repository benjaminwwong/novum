...
def reportc2():
    ...
    fpri("4NGEL","Albacorp also employs an array of drones and has a network of laser-powered detectors. Alterity's cloaking system will likely shield us from the drones, but the lasers will still detect us.")
...
def railc5():
    ...
    fpri("-->","The dusty green desert is broken by long metallic strips. The rails remind Rozen of ancient musical notation.")
...
def stopc6():
    ...
    fpri("Rozen","Uric, we're on the ground. Gear up and let's go before they can call reinforcements.")
...
def afterc72():
    ...
    img_print("hold.jpg")
    fpri("-->","Despite their hideous augmentations, the creatures were no match for industrial rounds of plasma.")
    fpri("-->","15 MINUTES LATER.")
    fpri("Faerri","That job almost seemed too easy.")
    fpri("Uric","I'm not complaining.")
    fpri("Rozen","Let's just get back to Kerensky and claim our reward.")
